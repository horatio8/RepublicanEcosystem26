...
export default function App() {
  ...
  const risingStars = React.useMemo(() => {
    return [...graph.nodes]
    ...
    <div className="app-container">
      ...
      <div className="main-content">
        <Sidebar
          ...
          risingStars={activeTab === 'Rising Stars' ? risingStars : null}
        />
              ...
              {risingStars.map((node) => (
                ...
                >
                  ...
                  <div className="event-meta">
                    {node.category} | {node.state || 'National'} |{' '}
                    Prominence: {node.prominence.toFixed(1)}
                    <span className="trend-badge rising" style={{ marginLeft: 8 }}>
                      ↑ Rising
                    </span>
                  </div>
                </div>
